...
- Display a list of Pokémon fetched from the API.
- Click on a Pokémon to view its details.
- Display Pokémon's name, image, abilities, and types on the detail page.
...
if you face any issue you need to run this command as well:
## `npm audit fix --force`
